...
public interface Constants {
    ...
    final static String OPERATION_EDIT = "edit";

    final static String TAG_EXCEPTION = "Exception";
    final static String TAG_FORMS = "Forms";
    final static String TAG_LIST = "List";
    final static String TAG_EVENT_CLICK = "EVENT_CLICK";

    final static String[] ARRAY_LIST_BLOCK_TYPE = {"String","Number","Boolean","List"};
